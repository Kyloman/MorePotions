...
public class LargeUnstableElixir extends AbstractPotion
{
    public static final Logger logger = LogManager.getLogger(AscendTheSpire.class.getName());

    public static final String POTION_ID = "ATS:LargeUnstableElixirPotion";
    ...
    public void use(final AbstractCreature target) {
        ...
        for(int z = 0; z < 15; z++) {
            ...
            //returnRandomPotion(AbstractPotion.PotionRarity.COMMON, limited);
    ...
    public AbstractPotion makeCopy() {
        return new LargeUnstableElixir();
    }
