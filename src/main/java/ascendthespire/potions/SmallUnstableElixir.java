...
public class SmallUnstableElixir extends CustomPotion {
    public static final Logger logger = LogManager.getLogger(AscendTheSpire.class.getName());

    public static final String POTION_ID = "ATS:SmallUnstableElixirPotion";
    ...
    public SmallUnstableElixir() {
        super(NAME, POTION_ID, PotionRarity.COMMON, PotionSize.S, PotionColor.STRENGTH);
    ...
    public void use(final AbstractCreature target) {
        ...
        //int rand = (int) (Math.random() * (5 * this.potency)); // 0-9
    ...
    public AbstractPotion makeCopy() {
        return new SmallUnstableElixir();
    }
    ...
    private int maybeNegative(int num){
        ...
        logger.info("converting to negative? " + num);
        return num;
    }
