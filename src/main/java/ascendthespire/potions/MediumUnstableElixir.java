...
public class MediumUnstableElixir extends AbstractPotion
{
    public static final Logger logger = LogManager.getLogger(AscendTheSpire.class.getName());

    public static final String POTION_ID = "ATS:MediumUnstableElixirPotion";
    ...
    public AbstractPotion makeCopy() {
        return new MediumUnstableElixir();
    }
